...
(*defining modifiers for toplevel class
	PUBLIC ? STRICTFP? FINAL?
	PUBLIC ? ABSTRACT?
*)
...
(*modifier_class_toplevel:
	|{[""]}
	(*|is_abstract=is_abstract {""::is_abstract}*)
	|PUBLIC is_final=is_final {"public "::is_final}
	|PUBLIC is_abstract=is_abstract {"public "::is_abstract} *)

(*is_final:
	| {[""]}
	| is_strictfp=is_strictfp {""::is_strictfp}
	| FINAL is_strictfp=is_strictfp {"final "::is_strictfp} *)
...
class_body:
	...
	(*|modifiers=modifiers_method;_type=what_type name=IDENT LEFT_BRACKET parameters=parameters RIGHT_BRACKET LEFT_BRACE RIGHT_BRACE  {Method{modifiers=modifiers;_type=_type;name=name;parameters=parameters}} *)
abstract_modifiers:
	|ABSTRACT {["abstract"]}
...
(* class_body :
	|{[]}
	|attribute=class_body_filled {attribute}
class_body_filled :
	|_type=what_type name=IDENT {[{_type=_type;name=name}]}
	|_type=what_type name=IDENT SEMICOLON attribute=class_body {{_type=_type;name=name}::attribute} *)
what_type :
	|INT {"int"}
	|VOID {"void"}
	|STRING {"String"}
